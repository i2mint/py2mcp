...
`input_trans` callable that [`py2mcp.mk_mcp_server()`](py2mcp.md#py2mcp.mk_mcp_server),
[`py2mcp.mk_mcp_from_refs()`](py2mcp.md#py2mcp.mk_mcp_from_refs), and the HTTP/stdio builders that wrap them
...
as `input_trans` to [`py2mcp.mk_mcp_server()`](py2mcp.md#py2mcp.mk_mcp_server) and friends.
...
#### SEE ALSO
[`py2mcp.mk_mcp_server()`](py2mcp.md#py2mcp.mk_mcp_server): where the returned callable is applied.

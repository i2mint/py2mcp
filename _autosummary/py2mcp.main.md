...
and does not run it; [`py2mcp.serve`](py2mcp.serve.md#module-py2mcp.serve) (stdio) and [`py2mcp.http`](py2mcp.http.md#module-py2mcp.http)
...
* **Parameters:**
  ...
  * **input_trans** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict)], [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict)]]) – Called with the dict of keyword arguments of every tool
    ...
    with [`py2mcp.mk_input_trans()`](py2mcp.md#py2mcp.mk_input_trans). `None` passes arguments
    through untouched.
...
[`py2mcp.mk_input_trans()`](py2mcp.md#py2mcp.mk_input_trans): build an `input_trans` from per-argument converters.

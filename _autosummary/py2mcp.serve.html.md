...
[`py2mcp.mk_mcp_server()`](py2mcp.html.md#py2mcp.mk_mcp_server) / [`py2mcp.mk_mcp_from_refs()`](py2mcp.html.md#py2mcp.mk_mcp_from_refs) build a server
...
[`py2mcp.util.import_object()`](py2mcp.util.html.md#py2mcp.util.import_object).
...
Thin wrapper over [`py2mcp.mk_mcp_from_refs()`](py2mcp.html.md#py2mcp.mk_mcp_from_refs) + `FastMCP.run` so that
